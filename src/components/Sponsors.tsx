  ...
  return (
    <section className="py-24 bg-slate-50 border-t border-slate-200 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 mb-20">
        ...
        <div className="relative w-full overflow-hidden py-10 bg-slate-100/50 border border-slate-200/80 rounded-2xl">
          ...
          <div className="flex w-max animate-infinite-scroll space-x-12 hover:[animation-play-state:paused]">
            {marqueeList.map((sponsor, index) => (
              <div
                ...
                className="flex flex-col items-center justify-center w-48 h-24 bg-white border border-slate-200/80 rounded-xl hover:border-brand-amber/40 hover:shadow-lg hover:shadow-brand-amber/5 grayscale hover:grayscale-0 opacity-60 hover:opacity-100 hover:scale-105 active:scale-95 transition-all duration-500 cursor-pointer select-none group"
              >
                ...
                />
                <span className="text-sm font-heading font-bold text-slate-800 tracking-wide">
                  {sponsor.name}
                </span>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="text-center mb-12">
          <h3 className="text-xl md:text-2xl font-heading font-bold text-slate-900 tracking-wide flex items-center justify-center space-x-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {winnersList.map((winner) => {
            ...
            return (
              <div 
                key={winner.id}
                className="group relative flex flex-col justify-between p-8 rounded-2xl bg-white border border-slate-200/80 hover:border-brand-amber/50 hover:shadow-2xl hover:shadow-brand-amber/5 transition-all duration-300"
              >
                ...
                <div className="space-y-6 relative z-10">
                  ...
                  <div className="space-y-2">
                    <h4 className="text-lg font-heading font-bold text-slate-800 group-hover:text-brand-orange transition-colors duration-300">
                      {winner.company}
                    </h4>
